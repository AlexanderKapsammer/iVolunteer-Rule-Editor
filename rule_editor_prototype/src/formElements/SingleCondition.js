    ...
    <div>
      ...
      >
        ...
        <optgroup label="general">
          ...
          <option value="years of working experience">
        ...
        <optgroup label="firebrigarde">
          ...
          <option value="Gruppenkommandantenprüfung">
            Gruppenkommandantenprüfung
          </option>
        </optgroup>
        <option value="more stuff">more stuff</option>
      </select>
      &nbsp;&nbsp;&nbsp;
      <button conditionindex={props.conditionindex} onClick={props.onRemove}>
        remove
      </button>
    </div>
  );
